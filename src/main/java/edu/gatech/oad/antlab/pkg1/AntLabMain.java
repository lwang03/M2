 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person1 p1 = new Person1("Li Wang");
		  toPrint += p1.toString("lwang405");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Devashru Patel");
		  toPrint += p2.toString("dpatel391");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Eric Ricci");
		  toPrint += p3.toString("ericci3");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Maggie Baxter");
                  toPrint += p4.toString("mbaxter31");
                  //Person5 replace P4 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("Amin Nadirali");
                  toPrint += p5.toString("anadirali3");
